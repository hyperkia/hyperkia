const html = `
	<section class="section">
		...
		<article class="tab">
			<div class="tabmenu">													
				<span class="tabmenu-item" data-target="uploadfile" data-class="tabmenu-item">Upload File</span>
				<span class="tabmenu-item active" data-target="fromurl" data-class="tabmenu-item">From URL</span>
			</div> 
			<div class="tabcontents">
				<div class="tabcontent" data-id="uploadfile">
					<div class="upload-sec">
						...
						<div class="upload-format">PSD, HTML, Hyperkia-JSON Formats</div>
				...
				<div class="tabcontent active" data-id="fromurl">
					<div class="fromurl-sec">
						<h3 class="fromurl-title">Import from Website</h3>
						<div class="fromurl-input-wrapper">
							<input class="fromurl-input" data-id="fromurlInput" type="url" placeholder="Enter website URL" value="https://www.codeclouds.com/case-studies/">
