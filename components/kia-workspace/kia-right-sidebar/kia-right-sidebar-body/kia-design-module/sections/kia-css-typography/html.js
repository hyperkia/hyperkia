	...
	<section part="module-section">
		...
		<div part="module-row">
			...
			<div part="module-col w79">
				<kia-prop-select data-prop="font-family" value="" data-id="font-family-select" data-name="font-family">
					<details class="select-wrapper">
				        <summary class="select-trigger">Add Font</summary>
			...
			<div part="module-col">				
				<kia-prop-input data-prop="font-size" data-unit="px" data-label-icon="type" data-type="number"></kia-prop-input> 
			</div>
			<div part="module-col">																			
				<kia-prop-input class="line-height-input" data-prop="line-height" data-unit="px" data-label-text="A" data-type="number"></kia-prop-input> 
			</div>
			<div part="module-col">																			
				<kia-prop-input class="letter-spacing-input" data-prop="letter-spacing" data-unit="px" data-label-text="A" data-type="number"></kia-prop-input> 
			</div>
			<div part="module-col w55">
